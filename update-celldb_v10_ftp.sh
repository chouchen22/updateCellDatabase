...
wget "http://topo.si.francetelecom.fr/ftp/index.php?c=get&user=HELU8341&file=Alcatel%2FCellules_2G.csv" -O alcatel2G.csv -q
...
wget "http://topo.si.francetelecom.fr/ftp/index.php?c=get&user=HELU8341&file=Ericsson2G%2FCellules_2G.csv" -O Ericsson2G.csv -q
...
wget "http://topo.si.francetelecom.fr/ftp/index.php?c=get&user=HELU8341&file=Ericsson3G%2FN_Cellules_3G.csv" -O Ericsson3G.csv -q
...
wget "http://topo.si.francetelecom.fr/ftp/index.php?c=get&user=HELU8341&file=Motorola%2FCellules_2G.csv" -O Motorola2g.csv -q
...
wget "http://topo.si.francetelecom.fr/ftp/index.php?c=get&user=HELU8341&file=Nortel%2FN_Cellules_3G.csv" -O Nortel3G.csv -q
...
wget "http://topo.si.francetelecom.fr/ftp/index.php?c=get&user=HELU8341&file=Nortel2G%2FCellules_2G.csv" -O Nortel2G.csv -q
