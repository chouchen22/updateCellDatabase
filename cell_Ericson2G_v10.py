...
file_json = open("geo2gericson.json",'w')
f = open(sys.argv[1], 'r') # opens the csv file
file_badRecords = open("Ericson2G_badRecords.csv", 'w')
nbRowCSV = 0
nbRowWithoutLati = 0
nbAzimutNotDigit = 0
...
try:
	...
	for row in reader:   # iterates the rows of the file in orders
		...
		#creation ligne dans fichier JSON AVEC complement adresse
